...
5. Real-system capture regression pipeline:
   - Win32 real capture script: `electron/scripts/context-menu-capture.ps1`
   - capture CLI wrapper: `scripts/stage6-real-capture.ts`
   - one-command real capture + visual gate: `scripts/stage6-real-regress.ts`
