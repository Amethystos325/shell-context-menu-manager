...
const EN_MESSAGES = {
  ...
  "language.zh": "Chinese",
  "language.en": "English",
  "app.subtitle": "Stage 6 Runtime Alignment In Progress | Version {version}",
  ...
  "status.systemMenuSnapshotFailed": "Read system registry menu failed: {error}",
  ...
  "preview.clipboardHasContent": "Clipboard Has Content",
  "preview.systemItems.label": "System/3rd-party Registry Snapshot (real-time)",
  "preview.systemItems.refresh": "Reload Registry",
  "preview.systemItems.loading": "Reading registry...",
  "preview.systemItems.empty": "No registry menu entries found for current context.",
  "preview.systemItems.disabled": "disabled",
  "preview.systemItems.hint":
    "These entries are read from runtime COM + local registry and used as the system/3rd-party baseline.",
...
const ZH_MESSAGES: Record<MessageKey, string> = {
  ...
  "language.zh": "中文",
  "language.en": "英文",
  "app.subtitle": "阶段 6 真实菜单一致性收敛中 | 版本 {version}",
  ...
  "status.systemMenuSnapshotFailed": "读取系统注册表菜单失败：{error}",
  ...
  "preview.clipboardHasContent": "剪贴板有内容",
  "preview.systemItems.label": "系统/第三方注册表快照（实时）",
  "preview.systemItems.refresh": "重新读取注册表",
  "preview.systemItems.loading": "正在读取注册表...",
  "preview.systemItems.empty": "当前场景未读取到注册表菜单项。",
  "preview.systemItems.disabled": "禁用",
  "preview.systemItems.hint": "这些条目来自运行时 COM + 本机注册表，并用于系统/第三方菜单基线渲染。",
